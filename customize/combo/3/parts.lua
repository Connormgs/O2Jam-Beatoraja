...
parts.filepath = {
	{name = "判定文字 Judge",									path = "../customize/judge/*",					def = "3"},
...
local function load(g)
	...
	local judge		= dofile(skin_config.get_path("../customize/judge/*") .. "/judge.lua")
	local jdetail	= dofile(skin_config.get_path("customize/judgedetail/*") .. "/judgedetail.lua")
