...
local function load(header)
	...
	-- レーンの横幅{{1P}, {2P}}
	t.lane.lane.w		= {{60, 58, 60, 120, 60, 58, 60, 20}}
	t.lane.lane.a		= 96

	-- ノーツの横幅{{1P}, {2P}}
	t.lane.notes.w		= {{70, 54, 70, 120, 70, 54, 70, 20}}
	-- ノーツの縦幅{{1P}, {2P}}
	t.lane.notes.h		= {{70, 40, 40, 40, 40, 40, 40, 40}}
	...
	-- BGA
	t.frame.bga = {
		{x = 0, y = 0, w = 0, h = 1080, a = 255, brightness = 255, stretch = 1}
	}
