...
local function load(g)
	...
	parts.note = {
		...
		size		= note.size,
		dst			= {},
		group		= {{id = "section-line", offset = 3, dst = {{x = g.lanes.x[1] + g.lane.outline.px, y = 999, w = g.lanes.w[1] - g.lane.outline.px * 2, h = 1, r = 128, g = 128, b = 128, a = g.lanes.barline.a}}}},
		time		= {{id = "section-line", offset = 3, dst = {{x = g.lanes.x[1] + g.lane.outline.px, y = 999, w = g.lanes.w[1] - g.lane.outline.px * 2, h = 1, r = 64,  g = 192, b = 192, a = g.lanes.barline.a}}}},
		bpm			= {{id = "section-line", offset = 3, dst = {{x = g.lanes.x[1] + g.lane.outline.px, y = 999, w = g.lanes.w[1] - g.lane.outline.px * 2, h = 2, r = 0,   g = 192, b = 0,   a = g.lanes.barline.a}}}},
		stop		= {{id = "section-line", offset = 3, dst = {{x = g.lanes.x[1] + g.lane.outline.px, y = 999, w = g.lanes.w[1] - g.lane.outline.px * 2, h = 2, r = 192, g = 192, b = 0,   a = g.lanes.barline.a}}}}
	}
